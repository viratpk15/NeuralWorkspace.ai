/**
 * Provider-independent system prompts for AI agents.
 *
 * This file has NO dependency on any LLM provider implementation
 * (Gemini, Ollama, OpenAI, etc.). It returns only string templates
