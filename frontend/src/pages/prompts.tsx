...
import type { Prompt, PromptCategory } from "@workspace/api-client-react";
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={formCategory}
                  onValueChange={(v) => setFormCategory(v as PromptCategory)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="review, best-practices, security"
                  value={formTags}
            ...
            >
              <CardHeader className="pb-3">
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  {prompt.tags?.slice(0, 2).map((tag: string, i: number) => (
